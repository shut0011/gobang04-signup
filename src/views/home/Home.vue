<template>
  <div class="home">
    ...
    <popover ref="winPop"><img src="~assets/img/others/haha.gif" /></popover>
    <popover ref="losePop"><img src="~assets/img/others/sad.gif" /></popover>
  </div>
