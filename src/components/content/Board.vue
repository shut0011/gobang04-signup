...
.board-inner {
  ...
  margin: 0 auto;
  position: relative;
  background-image: url("~assets/img/board/board.jpg");
  background-size: 100%;
}
.chessman, .step {
  position: absolute;
...
.step {
  color: white;
  background-image: url("~assets/img/board/white-t.png");
  background-size: 120% 120%;
  &.white {
    background-image: url("~assets/img/board/black-t.png");
...
.first-2 {
  ...
  .step {
    color: black;
    background-image: url("~assets/img/board/white.png");
    background-size: 115% 115%;
    &.white {
      background-image: url("~assets/img/board/black.png");
      background-size: 100% 100%;
      color: white;
    }
  }
